...
public class StudentInfoByName extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Информация о студенте по ФИО");
    ...
    private void findStudentPerformed() {
        ...
        if(Character.isLowerCase(lastName.charAt(0)) || 
                ...
                Character.isLowerCase(secondName.charAt(0))) {
            JOptionPane.showMessageDialog(this, "Имена собственные должны"
        ...
        String SQL = "SELECT * FROM student_getdisciplines ((SELECT distinct "
                + "recordbookid FROM view_students WHERE lastname = ? AND "
                + "firstname = ? AND secondname = ? AND semesterid = ?), ?)";
